...
export default function AttendeesList({ attendees, eventTitle }: AttendeesListProps) {
    ...
    return (
      <div className="wrapper mt-8">
        <div className="rounded-lg border border-gray-200 bg-white p-8 text-center">
          ...
          <h3 className="text-lg font-semibold text-gray-900">No attendees yet</h3>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-white/90">
                {filteredAttendees.length} {filteredAttendees.length === 1 ? 'ticket' : 'tickets'} sold
              </p>
            </div>
            <Button
              onClick={downloadCSV}
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-200 bg-white">
              {filteredAttendees.map((attendee, index) => (
                <tr key={attendee.id} className="transition-colors hover:bg-gray-50">
